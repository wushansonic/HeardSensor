...
public class ToastUtil {
     ...
     * @param duration 弹出Toast的持续时间
     */
    public static void showPositions(Context ctx, CharSequence msg, int duration)
            throws NullPointerException {
        toastPositions(ctx, msg, duration);
    }

    private static void toastPositions(Context ctx, CharSequence msg, int duration) {
        Toast toast = android.widget.Toast.makeText(ctx, msg, duration);
